...
public class Enemigo4 : MonoBehaviour
{
    ...
    public bool TiradaDeExito()
    {
        ...
        else
        {
            ...
            {
                Debug.Log("Pifia en el ataque del enemigo 4, no se hace da�o.");
                return false;
            }
            else if (valorAtaque < 70 && valorAtaque > fuerza)
            {
                Debug.Log("El ataque del enemigo 4 es exitoso, supera la fuerza del personaje.");
                return true;
            }
            else
            {
                Debug.Log("El ataque del enemigo 4 no es exitoso, no supera la fuerza del personaje.");
                return false;
            }
        }
    }
